...
fun LoginScreen(
  ...
  Box(
    ...
    Column(
      ...
      Text(text = stringResource(com.suwiki.presentation.common.ui.R.string.word_login), style = SuwikiTheme.typography.header1)
      ...
      SuwikiRegularTextField(
        ...
        label = stringResource(com.suwiki.presentation.common.ui.R.string.word_id),
      ...
      SuwikiRegularTextField(
        ...
        label = stringResource(com.suwiki.presentation.common.ui.R.string.word_password),
      ...
      Row(
        ...
        Text(
          ...
          text = stringResource(com.suwiki.presentation.common.ui.R.string.word_find_id),
        ...
        Text(
          ...
          text = stringResource(com.suwiki.presentation.common.ui.R.string.word_find_password),
          style = SuwikiTheme.typography.body5,
          color = Gray6A,
        )
        VerticalDivider(
        ...
        Text(
          ...
          text = stringResource(com.suwiki.presentation.common.ui.R.string.word_signup),
      ...
      SuwikiContainedLargeButton(
        ...
        text = stringResource(com.suwiki.presentation.common.ui.R.string.word_login),
    ...
    if (uiState.showLoginFailDialog) {
      SuwikiDialog(
        ...
        confirmButtonText = stringResource(com.suwiki.presentation.common.ui.R.string.word_confirm),
